...
def test_refine3d_widget(
    ...
    tester.write_random_mrc("run_it000_half1_class001.mrc", (6, 6, 6))
    tester.write_text("run_it000_class001_angdist.bild", _BILD_TEXT)
    ...
    tester.write_random_mrc("run_it001_half1_class001.mrc", (6, 6, 6))
    tester.write_text("run_it001_class001_angdist.bild", _BILD_TEXT)
    tester.write_random_mrc("run_it001_half2_class001.mrc", (6, 6, 6))

    assert tester.widget._viewer.has_image

    tester.write_text("run_it001_half1_class001_angdist.bild", _BILD_TEXT)
    tester.widget._arrow_visible.setChecked(True)
    QApplication.processEvents()
