...
JOB_ID_MAP = {
    ...
    "relion.reconstructtomograms": "Recon. Tomos",
    ...
    "relion.reconstructparticletomo": "Recon. Particles",
    ...
    "relion.select.discard": "Discard Particles",
...
configure_submenu(MenuId.RELION_RECONSTRUCTION_JOB, "Job: Reconstruct/Refine")
configure_submenu(MenuId.RELION_UTILS_JOB, "Job: Utilities")
configure_submenu(MenuId.RELION_TILT_ALIGN_JOB, "Job: Tilt Align")
configure_submenu(MenuId.RELION_TOMO_RECON_JOB, "Job: Tomo Reconstruct")
configure_submenu(MenuId.RELION_REFINE_JOB, "Job: High-resolution Refine")
