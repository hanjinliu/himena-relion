...
class InspectParticlesSPAWidget(QtW.QWidget):
    def __init__(self, job_dir: _job_dir.JobDirectory):
        ...
        layout.addWidget(self._show_points_switch.native)
    ...
    def initialize(self, job_dir: _job_dir.JobDirectory):
        ...
        self._job_dir = job_dir
        self._viewer.clear()
        if (mic_path := self._job_dir.path / "micrographs.star").exists():
        ...
        if (particles_path := self._job_dir.path / "particles.star").exists():
